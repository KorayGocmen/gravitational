...
# This should not be here on a production system.
API_KEY = 0bfae22b-3977-479f-9a01-764a1734abbe
...
run_scheduler:
	$(SCHEDULER_PATH)/$(SCHEDULER_BINARY) --api_key=$(API_KEY)
...
run_worker:
	$(WORKER_PATH)/$(WORKER_BINARY) --api_key=$(API_KEY)
